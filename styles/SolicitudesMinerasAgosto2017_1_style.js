...
var style_SolicitudesMinerasAgosto2017_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(227,25,217,1.0)'}),
...
function update() {
    ...
    var features = lyr_SolicitudesMinerasAgosto2017_1.getSource().getFeatures();
